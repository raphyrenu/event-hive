    ...
    <div className="flex flex-row items-center justify-between min-h-screen bg-background h-screen text-foreground">
      ...
      <h2 className="font-bold text-3xl">
        ...
        <h1 className="lg:text-4xl text-3xl md:text-4xl font-bold mb-12 mt-10">
          ...
          <form
            className="w-3/5 bg-transparent px-20 flex items-center justify-center flex-col  rounded-md shadow-md"
            ...
            <div className="mb-6 relative">
              ...
              >
                {showPassword ? <FaEyeSlash size={25} color="black"/> : <FaEye size={25} color="black"/>}
                      </span>
      ...
      >
        <h1 className="text-5xl mb-10">Hello Freind</h1>
        <p className="mb-10">
